...
public class DialogBuy extends javax.swing.JDialog implements WSResultListener {
    ...
    private void initComponents() {
        ...
        jXLabel1.setText("First name");

        jXLabel2.setText("Second name");

        jXLabel3.setText("Passport");

        jXLabel4.setText("Familly name");

        jXLabel5.setText("Add info");

        jXLabel6.setText("Credit Card");
        jXLabel6.setFont(new java.awt.Font("Tahoma", 1, 21)); // NOI18N

        jXLabel7.setText("E-mail");
    ...
    private void btnBuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuyActionPerformed
        ...
        boolean result = FlightRSClient.getInstance().buyTicket(flight.getId(), place.getId(), passenger, txtAddInfo.getText());
