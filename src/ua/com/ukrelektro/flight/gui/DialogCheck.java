...
public class DialogCheck extends javax.swing.JDialog implements WSResultListener {
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        if (reservation != null) {
            ...
            sb.append("Code: ").append(reservation.getFlight().getCode()).append("\n");
            sb.append("Aircraft: ").append(reservation.getFlight().getAircraft().getName()).append("\n");
            sb.append("Depart: ").append(reservation.getFlight().getDateDepart()).append("\n");
            sb.append("Arrivel: ").append(reservation.getFlight().getDateCome()).append("\n");
            sb.append("Place: ").append(reservation.getPlace().getSeatLetter()).append(reservation.getPlace().getSeatNumber()).append("\n");
